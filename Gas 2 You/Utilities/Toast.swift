...
class Toast {
    ...
    static func show(title: String = "" ,delay :Double = 3.5,  message: String, state : MessageAlertState ,  completion: (() -> Void)? = nil) {
        ...
        DispatchQueue.main.async {
            ...
            UIView.animate(withDuration: 0.5, delay: 0.0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: [.beginFromCurrentState, .curveLinear, .allowUserInteraction], animations: {
                //                toastContainer.alpha = 1.0
