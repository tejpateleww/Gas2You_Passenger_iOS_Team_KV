                        ...
                        if self.isfromMember{
                            ...
                            slideToConfirmVC.completion = {
                                self.cardListModel.doAddBooking(customerid: Singleton.sharedInstance.userId,
                                                                ...
                                                                lat: (Singleton.sharedInstance.carParkingLocation.coordinate.latitude == 0.0) ? "\(Singleton.sharedInstance.userCurrentLocation.coordinate.latitude )" : "\(Singleton.sharedInstance.carParkingLocation.coordinate.latitude )",
                                                                lng: (Singleton.sharedInstance.carParkingLocation.coordinate.longitude == 0.0) ? "\(Singleton.sharedInstance.userCurrentLocation.coordinate.longitude )" : "\(Singleton.sharedInstance.carParkingLocation.coordinate.longitude )",
